        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4">
                    ...
                    <p>
                        Your one-stop shop for modern home decor and furniture. We offer
                ...
                <div class="col-lg-4 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <i class="fas fa-map-marker-alt me-2"></i> 123 Design Street,
                            New Delhi, 110059
                        </li>
                        <li class="mb-2">
                        ...
                        <li class="mb-2">
                            <i class="fas fa-envelope me-2"></i> hello@ecommerce.com
                        </li>
                        <li>
                            <i class="fas fa-clock me-2"></i> Mon-Fri: 9AM-6PM, Sat:
                            10AM-4PM
                        </li>
                    </ul>
                </div>
