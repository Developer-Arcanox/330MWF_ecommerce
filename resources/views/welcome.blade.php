    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="category-card">
                    <img
                        src="https://images.unsplash.com/photo-1565538810643-b5bdb714032a?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                        class="category-img w-100"
                        alt="Decor" />
                    <div class="card-body text-center">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-card card h-100">
                    <img
                        src="https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                        class="product-img card-img-top"
                        alt="Product 2" />
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-card card h-100">
                    <img
                        src="https://images.unsplash.com/photo-1592078615290-033ee584e267?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                        class="product-img card-img-top"
                        alt="Product 4" />
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
